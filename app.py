...
def get_all_data():
    try:
        ...
        # --- UNICA MODIFICA: FIX TYPEERROR ---
        # Forza la colonna Contestazioni a essere testo per evitare il crash in scrittura
...
# --- DA QUI IN POI IL CODICE RIMANE IDENTICO AL TUO ORIGINALE ---
